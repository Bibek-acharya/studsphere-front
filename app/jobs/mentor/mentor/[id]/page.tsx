...
const MENTORS_DATA = {
  ...
  "2": {
    ...
    sessions: 64,
    attendance: 96,
    bio: "Experienced consultant specializing in case competitions and MBA exam preparation.",
  ...
  "3": {
    ...
    sessions: 450,
    attendance: 98,
    bio: "Senior PM at Google focused on product strategy and interview preparation.",
