...
const App: React.FC = () => {
  ...
  const handleViewDetails = (id: string) => {
    router.push(`/colleges/entrance/${id}`);
  };
          ...
          <div className="grow">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <div className="flex items-center flex-wrap gap-2">
                <span className="text-sm font-bold text-slate-400 mr-2 uppercase tracking-wide">
                  Active:
                </span>
                <span className="inline-flex items-center bg-white border border-slate-200 px-3 py-1 rounded-full text-xs font-semibold text-slate-700">
                  Bachelor{" "}
                  <X className="w-3 h-3 ml-2 cursor-pointer text-slate-400 hover:text-slate-600" />
                </span>
                <span className="inline-flex items-center bg-white border border-slate-200 px-3 py-1 rounded-full text-xs font-semibold text-slate-700">
                  TU{" "}
                  <X className="w-3 h-3 ml-2 cursor-pointer text-slate-400 hover:text-slate-600" />
                </span>
                <button className="text-xs font-bold text-blue-600 hover:text-blue-700 hover:underline px-2 transition-all">
                  Clear All
                </button>
              </div>
              <p className="text-sm font-medium text-slate-500">
                Showing <span className="text-slate-900 font-bold">100</span>{" "}
      ...
      <footer className="bg-white border-t border-slate-200 py-12 px-6">
        <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <p className="text-slate-400 text-sm font-medium">
            © 2024 EduPortal Nepal. All rights reserved.
          </p>
