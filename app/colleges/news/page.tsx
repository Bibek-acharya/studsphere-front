  ...
  const newsItems = [
    {
      ...
      description:
        "NTA extends JEE Main 2025 registration deadline due to high volume of applications.",
      daysAgo: 90,
    },
    {
      category: "Admission",
      ...
      <section className="w-full bg-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-blue-600 underline text-sm mb-8">
            ...
            <br />
            important updates from Tribhuvan University. All the information you
            need,
            <br />
            in one place.
          </p>
          ...
          {/* Category Filters */}
          <div className="mb-8">
            <h3 className="text-left text-lg font-semibold mb-4 text-black">
              Browse by category
            </h3>
              ...
              <div className="relative h-80">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mb-2">
                    Merit-Based Scholarships Announced for 2026
                  </h2>
                  <p className="text-sm text-gray-200 mb-4">
                    Full tuition waiver for top 50 candidates in entrance
                    examination.
                  </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2">
            <Button
              variant="outline"
              size="icon"
              className="w-8 h-8 rounded-md border-gray-300 bg-transparent"
            >
              ‹
            </Button>
            <Button className="w-8 h-8 rounded-md bg-blue-600 text-white hover:bg-blue-700">
              1
            </Button>
            <Button
              variant="outline"
