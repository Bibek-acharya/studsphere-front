              ...
              <div className="p-8">
                ...
                <div className="prose max-w-none mb-8">
                  ...
                  <p className="text-gray-700 mb-4">
                    The previous deadline for counseling registration was set
                    for December 10th, 2024. The new revised schedule is as
                    follows:
                  </p>

                  <ul className="space-y-3 mb-8">
                    <li className="text-gray-800">
                      <strong>New Registration Deadline:</strong> December 20th,
                      2024 (5:00 PM NST)
                    </li>
                    <li className="text-gray-800">
                      <strong>Choice Filling Deadline:</strong> December 20th,
                      2024
                    </li>
                    <li className="text-gray-800">
                      <strong>Seat Allotment (Round 1):</strong> December 25th,
                      2024
                    </li>
                    <li className="text-gray-800">
                      <strong>Fee Payment & Document Verification:</strong>{" "}
                      December 26th - 28th, 2024
                    </li>
                  </ul>
                  ...
                  <ol className="space-y-3 mb-8 list-decimal pl-6">
                    <li className="text-gray-800">
                      Log in to the admission portal using your credentials
                    </li>
                    <li className="text-gray-800">
                      Verify and update your personal information if needed
                    </li>
                    <li className="text-gray-800">
                      Complete the choice filling process carefully
                    </li>
                    <li className="text-gray-800">
