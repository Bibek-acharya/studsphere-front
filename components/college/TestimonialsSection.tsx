  ...
  return (
    <div className="py-16 text-center overflow-hidden">
      ...
      <div className="relative">
        {/* Fade effects */}
        <div className="absolute left-0 top-0 h-full w-20 bg-linear-to-r from-gray-50 to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 h-full w-20 bg-linear-to-l from-gray-50 to-transparent z-10 pointer-events-none" />
        ...
        <div className="flex gap-6 animate-scroll-left">
          {duplicatedTestimonials.map((testimonial, index) => (
            <div
              ...
              className="shrink-0 w-80 bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 text-left relative"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center">
                  <div className={`w-12 h-12 ${testimonial.initialsColor} rounded-full flex items-center justify-center text-white font-semibold text-lg mr-4 shrink-0`}>
